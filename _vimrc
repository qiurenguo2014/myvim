...
set tags+=../../tags;
set tags+=../../../tags;
set tags+=E:\MyFunc\tag\FreeRTOS\tags
set tags+=E:\MyFunc\tag\Libraries\tags
" -----------------------------------------------------------------------------
...
let g:vimrc_author   = 'Allen'                " 昵称
let g:vimrc_email    = 'qiurenguo@gmail.com'         " 邮箱
...
nmap <leader>mt <ESC>:!ctags -R --c++-kinds=+p --fields=+iaS --extra=+q
